...
class MinHeap {
    ...
    #sinkDown(parentIndex) {
        ...
        while (this.data[parentIndex] > this.#getChildLeftValue(parentIndex) ||
            this.data[parentIndex] > this.#getChildRightValue(parentIndex)) {
            // Find the index of the smaller child.
            const minValue = Math.min(this.#getChildLeftValue(parentIndex), this.#getChildRightValue(parentIndex));
